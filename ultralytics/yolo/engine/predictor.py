...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None):
        ...
        if self.args.verbose and self.seen:
            ...
            # LOGGER.info(f'Speed: %.1fms preprocess, %.1fms inference, %.1fms postprocess per image at shape ' f'{(1, 3, *self.imgsz)}' % t)
            LOGGER.info(f'>> YOLO segmentation process time: {t[1]:.4f} ms.')
