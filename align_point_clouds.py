...
list_kp1, list_kp2 = find_matching_features_nn(EXP_IDS[0], EXP_IDS[1])
...
rot_mat, trans_mat = find_rotation_translation(first_pointset, second_pointset)
...
# o3d.io.write_point_cloud(filename=f"feature_matching_images/segmented_lab_scenes.pcd", 
