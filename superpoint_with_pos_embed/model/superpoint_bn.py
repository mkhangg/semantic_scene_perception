...
from model.modules.cnn.vgg_backbone import VGGBackbone,VGGBackboneBN, PEBackbone_MOD
...
class SuperPointBNNet(torch.nn.Module):
    ...
    def __init__(self, config, input_channel=1, grid_size=8, device='cpu', using_bn=True):
        ...
        if using_bn:
            ...
            # self.backbone = PEBackbone_MOD(config['backbone']['vgg'], input_channel, device=device)
        ##
